...
const BlogPost = () => {
  ...
  if (isLoading) {
    return <p className="text-muted-foreground py-20 text-center">Loading...</p>;
  }
  ...
  return (
    <article>
      ...
      <div className="flex items-baseline gap-3 mb-3">
        <span className="text-[10px] uppercase tracking-widest text-primary font-medium">{post.category}</span>
